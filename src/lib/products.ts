...
import acc2 from "@/assets/p-acc2.jpg";
...
const rawProducts: Product[] = [
  { id: "lap-001", name: "ProBook Gaming X1", nameAr: "بروبوك جيمنغ X1", brand: "Lenovo", price: 1299, category: "laptops", subcategory: "gaming", subcategoryAr: "جيمنغ", image: laptop1, gallery: [laptop1, laptop2, laptop1], overviewGallery: [], stock: 8, overview: "Powerful gaming laptop with RTX graphics and high refresh display for competitive play.", overviewAr: "لابتوب جيمنغ قوي مع كرت RTX وشاشة بتردد عالٍ لتجربة لعب احترافية.", specs: laptopSpecs },
  { id: "lap-002", name: "TouchSlim 14 OLED", nameAr: "تتش سليم 14 OLED", brand: "HP", price: 999, category: "laptops", subcategory: "touch", subcategoryAr: "تتش", image: laptop2, gallery: [laptop2, laptop1, laptop2], overviewGallery: [], stock: 12, overview: "Ultra-thin touchscreen laptop with OLED display and all-day battery.", overviewAr: "لابتوب تتش نحيف جداً بشاشة OLED وبطارية تدوم طوال اليوم.", specs: laptopSpecs },
  { id: "lap-003", name: "EliteBook 13", nameAr: "إيليت بوك 13", brand: "Dell", price: 799, category: "laptops", subcategory: "standard", subcategoryAr: "عادي", image: laptop1, gallery: [laptop1, laptop2, laptop1], overviewGallery: [], stock: 0, overview: "Reliable everyday laptop for work and study.", overviewAr: "لابتوب موثوق للاستخدام اليومي للعمل والدراسة.", specs: laptopSpecs },
  { id: "prn-001", name: "OfficeJet Pro M404", nameAr: "أوفيس جيت برو M404", brand: "HP", price: 249, category: "printers", subcategory: "office", subcategoryAr: "مكتبية", image: printer1, gallery: [printer1, printer2, printer1], overviewGallery: [], stock: 15, overview: "Compact office printer with fast laser printing and Wi-Fi.", overviewAr: "طابعة مكتبية مدمجة بطباعة ليزر سريعة ودعم واي فاي.", specs: printerSpecs },
  { id: "prn-002", name: "Enterprise MFP 5800", nameAr: "إنتربرايز MFP 5800", brand: "Canon", price: 1899, category: "printers", subcategory: "enterprise", subcategoryAr: "للشركات", image: printer2, gallery: [printer2, printer1, printer2], overviewGallery: [], stock: 4, overview: "Heavy-duty multifunction printer for high-volume offices.", overviewAr: "طابعة متعددة الوظائف لمكاتب الإنتاج العالي.", specs: printerSpecs },
  { id: "dsk-001", name: "All-in-One Studio 24", nameAr: "أول إن وان ستوديو 24", brand: "Apple", price: 1499, category: "desktops", subcategory: "standard", subcategoryAr: "عادي", image: desktop1, gallery: [desktop1, desktop1, desktop1], overviewGallery: [], stock: 6, overview: "Sleek all-in-one desktop with 24\" display.", overviewAr: "جهاز حاسوب أنيق متكامل بشاشة 24 بوصة.", specs: laptopSpecs },
  { id: "cas-001", name: "Vortex RGB Tower", nameAr: "فورتكس RGB تاور", brand: "NZXT", price: 189, category: "cases", subcategory: "gaming", subcategoryAr: "جيمنغ", image: case1, gallery: [case1, case1, case1], overviewGallery: [], stock: 20, overview: "Premium ATX tower with tempered glass and RGB fans.", overviewAr: "كيس ATX فاخر بزجاج مقوّى ومراوح RGB.", specs: [{ group: "Form", items: [{ label: "Type", value: "Mid-Tower ATX" }, { label: "Material", value: "Steel + Tempered Glass" }] }] },
  { id: "acc-001", name: "Phantom Wireless Mouse", nameAr: "ماوس فانتوم لاسلكي", brand: "Logitech", price: 79, category: "accessories", subcategory: "standard", subcategoryAr: "عادي", image: acc1, gallery: [acc1, acc1, acc1], overviewGallery: [], stock: 50, overview: "Precision wireless mouse with RGB and 25K DPI sensor.", overviewAr: "ماوس لاسلكي دقيق مع RGB وحساس 25K DPI.", specs: [{ group: "Specs", items: [{ label: "DPI", value: "25,600" }, { label: "Battery", value: "70 hours" }] }] },
  { id: "acc-002", name: "Mech RGB Keyboard", nameAr: "كيبورد ميكانيكي RGB", brand: "Razer", price: 149, category: "accessories", subcategory: "gaming", subcategoryAr: "جيمنغ", image: acc2, gallery: [acc2, acc2, acc2], overviewGallery: [], stock: 30, overview: "Mechanical gaming keyboard with per-key RGB.", overviewAr: "كيبورد ميكانيكي للجيمنغ بإضاءة RGB لكل زر.", specs: [{ group: "Specs", items: [{ label: "Switch", value: "Optical Linear" }, { label: "Layout", value: "TKL" }] }] },
];
...
export function normalizeProduct(p: Product): Product {
  ...
  const overviewGallery = Array.isArray(p.overviewGallery) && p.overviewGallery.length > 0
    ? p.overviewGallery
    : seed?.overviewGallery?.length
